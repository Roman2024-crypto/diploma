...
#  Курсовая работа по профессии «Системный админитсратор»
...
Виртуальные сервера развернуты в облаке Yandex c помошью Terraform. В ansible inventory IP аддреса не используются.
Данные сервера имеют минимальную конфигруацию.
...
Группа web серверов находятся в Instance-Group.
...
![img](https://github.com/Roman2024-crypto/diploma/blob/Production/images/target-group.png)

Создана Backend Group

![img](https://github.com/Roman2024-crypto/diploma/blob/Production/images/back-group.png)

Создан HTTP router

![img](https://github.com/Roman2024-crypto/diploma/blob/Production/images/http-router.png)

Создан Application load balancer

![img](https://github.com/Roman2024-crypto/diploma/blob/Production/images/alb.png)

### Мониторинг
Создайте ВМ, разверните на ней Zabbix. На каждый webserverустановите Zabbix Agent, настройте агенты на отправление метрик в Zabbix. 

Настройте дешборды с отображением метрик, минимальный набор — по принципу USE (Utilization, Saturation, Errors) для CPU, RAM, диски, сеть, http запросов к веб-серверам. Добавьте необходимые tresholds на соответствующие графики.

### Решение

Zabbix доступен по ссылке: http://51.250.12.252:8080/

![img](https://github.com/Roman2024-crypto/diploma/blob/Production/images/zabbix.png)

Дашборды:

![img](https://github.com/Roman2024-crypto/diploma/blob/Production/images/zabbix-dashbords.png)
...
Kibana с подлюченным Elasticsearch доступна по ссылке - http://89.169.157.38:5601/app/discover#/?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-15m,to:now))&_a=(columns:!(),filters:!(),index:a5761760-f904-11ef-9d5a-611ca6046251,interval:auto,query:(language:kuery,query:''),sort:!(!('@timestamp',desc)))

![img](https://github.com/Roman2024-crypto/diploma/blob/Production/images/elastic.png)
